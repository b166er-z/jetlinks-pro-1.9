package org.jetlinks.pro.elastic.search.aggreation.enums;
...
import org.jetlinks.pro.elastic.search.aggreation.bucket.Sort;
import org.jetlinks.pro.elastic.search.aggreation.bucket.AggregationResponseHandle;
import org.jetlinks.pro.elastic.search.aggreation.bucket.Bucket;
import org.jetlinks.pro.elastic.search.aggreation.bucket.BucketAggregationsStructure;
import org.jetlinks.pro.elastic.search.aggreation.metrics.MetricsAggregationStructure;
...
public enum BucketType {
    ...
    TERMS("字段项") {
        ...
        public AggregationBuilder aggregationBuilder(BucketAggregationsStructure structure) {
            ...
            builder.subAggregation(AggregationBuilders.topHits(structure.getName()).size(1));
            return builder;
        }
