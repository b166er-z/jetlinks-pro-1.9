...
import org.jetlinks.pro.elastic.search.aggreation.metrics.MetricsResponse;
import org.jetlinks.pro.elastic.search.aggreation.metrics.MetricsResponseSingleValue;
...
public enum MetricsType {
    ...
    FIRST("第一条数据") {
        ...
        @Override
        public MetricsResponse getResponse(String name, SearchResponse response) {
            TopHits topHits = response.getAggregations().get(name);
            return null;
        }
    },
    SUM("总数") {
