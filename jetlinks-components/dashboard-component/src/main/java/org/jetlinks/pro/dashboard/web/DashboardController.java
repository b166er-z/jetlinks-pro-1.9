package org.jetlinks.pro.dashboard.web;
...
import org.jetlinks.pro.dashboard.web.request.DashboardMeasurementRequest;
import org.jetlinks.pro.dashboard.web.response.DashboardInfo;
import org.jetlinks.pro.dashboard.web.response.DashboardMeasurementResponse;
import org.jetlinks.pro.dashboard.web.response.MeasurementInfo;
...
public class DashboardController {
    ...
    public Flux<DashboardMeasurementResponse> getMultiMeasurementValue(@RequestBody Flux<DashboardMeasurementRequest> requests) {
        return requests
            .doOnNext(DashboardMeasurementRequest::validate)
