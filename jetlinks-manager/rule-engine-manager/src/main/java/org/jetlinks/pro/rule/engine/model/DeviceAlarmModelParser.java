...
import org.jetlinks.pro.rule.engine.device.DeviceAlarmRule;
import org.jetlinks.pro.rule.engine.entity.DeviceAlarmEntity;
import org.jetlinks.pro.rule.engine.executor.DeviceMessageSendTaskExecutorProvider;
    ...
    public RuleModel parse(String modelDefineString) {
        ...
        //处理定时触发
        {
            ...
            for (DeviceAlarmRule.Trigger timerTrigger : timerTriggers) {
                ...
                timer.setSchedulingRule(SchedulerSelectorStrategy.minimumLoad());
                ...
                senderDeviceMessageSendConfig.setAsync(true);
